...
export default function WorkCard() {
  return (
    <div className="h-fit md:sticky md:top-24 w-full md:w-[23rem] flex-shrink-0">
          ...
          <div>
            <div className="flex items-start justify-between gap-1">
              ...
              <div className="inline-flex items-center text-base">
                <a href="https://github.com/mohed-abbas/collaboard" target="_blank" rel="noopener noreferrer" className="rounded p-1 transition hover:bg-neutral-200 dark:hover:bg-neutral-800">
                  <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 256 256">
                ...
                <a href="" target="_blank" rel="noopener noreferrer" className="rounded p-1 transition hover:bg-neutral-200 dark:hover:bg-neutral-800">
                  <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 256 256">
