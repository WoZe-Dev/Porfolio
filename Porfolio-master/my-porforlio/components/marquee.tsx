...
const Marquee: React.FC = () => {
  return (
    <><AuroraBackgroundmarque>
      <div className="vertical mx-auto flex flex-col md:flex-row gap-8 pt-4 pb-8 w-full">

        {/* Left column: text */}
        <div className="flex flex-col space-y-4 flex-1">
          <h2 className="text-xs opacity-70">Développeur Full-Stack</h2>
          <p>
